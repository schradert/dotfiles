...
in {
  ...
  dotfiles.nodes = {
    bootstrap = {
      provider.hetzner.server_type = "cpx11";
      system.dotfiles.services.headscale.enable = true;
    };
    sirver.system = {
    ...
    axolotl.system = {
      ...
      dotfiles.client.workstation.enable = true;
    ...
    systeamadeck.system = {pkgs, ...}: {
      ...
      dotfiles.client.gaming.enable = true;
    ...
    falcon.system = {
      ...
      dotfiles.client.gaming.enable = true;
      dotfiles.client.workstation.enable = true;
      dotfiles.hardware.nvidia.enable = true;
