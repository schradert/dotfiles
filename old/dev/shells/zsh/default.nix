  ...
  dotfiles = {
    ...
    nixos = {
      ...
      config = lib.mkIf config.dotfiles.programs.zsh.enable {
        ...
        # TODO should all shells be added to environment.shells?
        environment.shells = [pkgs.zsh];
        programs.zsh.enable = true;
        # TODO extract default shell into a module elsewhere
    ...
    home-manager = {
      ...
      inherit (lib) cleanSource flatten mkIf optionals;
    in {
      config = mkIf config.dotfiles.programs.zsh.enable {
