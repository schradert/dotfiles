{
  ...
  dotfiles = {
    ...
    options.services.jitsi.enable = lib.mkEnableOption "Jitsi";
      ...
      in {
        kubernetes.helm.releases.jitsi = {
          ...
          values = {
            ...
            enableGuests = false;
            publicURL = subdomain;
            jicofo.xmpp.password = default "passwords/jitsi-jicofo";
            jigasi.enabled = true;
            jigasi.xmpp.password = default "passwords/jitsi-jigasi";
            jibri = {
              enabled = true;
              ...
              shm.useHost = true;
              singleUseMode = true;
              xmpp.password = default "passwords/jitsi-jibri";
              recorder.password = default "passwords/jitsi-recorder";
            };
            jvb = {
              metrics.enabled = true;
              ...
              xmpp.password = default "passwords/jitsi-jvb";
            };
            prosody.persistence = {
              enabled = true;
              size = "1Gi";
