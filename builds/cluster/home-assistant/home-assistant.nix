{
  ...
  # TODO https://github.com/leofabri/hassio_appliance-status-monitor
  ...
  #       # NOTE https://www.home-assistant.io/integrations/
  #       # config = {};
  #       # NOTE https://github.com/home-assistant/core/blob/2117e35d53b1cf397a149ee9f45f3089f94d4bb4/homeassistant/bootstrap.py#L109
  #       # defaultIntegrations = [];
  #     };
